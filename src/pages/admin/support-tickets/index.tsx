                ...
                <Table sx={{ minWidth: 800, width: '100%' }}>
                  <TableHead>
                    <TableRow sx={{ bgcolor: '#F9FAFB' }}>
                      <TableCell sx={{ fontWeight: 700, color: '#111827', whiteSpace: 'nowrap' }}>Subject</TableCell>
                      <TableCell sx={{ fontWeight: 700, color: '#111827', whiteSpace: 'nowrap' }}>User</TableCell>
                      ...
                      <TableCell sx={{ fontWeight: 700, color: '#111827', whiteSpace: 'nowrap' }}>Priority</TableCell>
                      <TableCell sx={{ fontWeight: 700, color: '#111827', whiteSpace: 'nowrap' }}>Created</TableCell>
                  ...
                  <TableBody>
                    {filteredTickets.map((ticket) => (
                      <TableRow key={ticket.id} sx={{ '&:hover': { bgcolor: '#F9FAFB' } }}>
                        ...
                        <TableCell sx={{ color: '#6B7280' }}>{ticket.user}</TableCell>
                        <TableCell sx={{ color: '#6B7280' }}>{ticket.email}</TableCell>
                        <TableCell>
                          <Chip
                            label={ticket.status}
                            size="small"
