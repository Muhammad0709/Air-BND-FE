            ...
            <CardContent sx={{ p: { xs: 2, md: 4 } }}>
              ...
              <Stack spacing={3}>
                <Stack direction="row" spacing={2} alignItems="center">
                  ...
                  <Box>
                    <Typography sx={{ fontSize: 12, color: '#6B7280', mb: 0.5 }}>Guest Name</Typography>
                    <Typography sx={{ fontWeight: 600, color: '#111827' }}>{booking.guest}</Typography>
                  </Box>
                </Stack>
                <Divider />
                <Stack direction="row" spacing={2} alignItems="center">
                  ...
                  <Box>
                    ...
                    <Typography sx={{ fontWeight: 600, color: '#111827' }}>{booking.guestEmail}</Typography>
                  </Box>
                </Stack>
                <Divider />
                <Stack direction="row" spacing={2} alignItems="center">
                  ...
                  <Box>
                    <Typography sx={{ fontSize: 12, color: '#6B7280', mb: 0.5 }}>Phone</Typography>
                    <Typography sx={{ fontWeight: 600, color: '#111827' }}>{booking.guestPhone}</Typography>
                  </Box>
                </Stack>
              </Stack>
            </CardContent>
            ...
            <CardContent sx={{ p: { xs: 2, md: 4 } }}>
              ...
              <Stack spacing={3}>
                <Stack direction="row" spacing={2} alignItems="center">
                  ...
                  >
                    <HotelIcon sx={{ fontSize: 20, color: '#6B7280' }} />
                  </Box>
                  <Box>
                    <Typography sx={{ fontSize: 12, color: '#6B7280', mb: 0.5 }}>Property</Typography>
                    <Typography sx={{ fontWeight: 600, color: '#111827' }}>{booking.property}</Typography>
                    <Typography sx={{ fontSize: 12, color: '#6B7280' }}>{booking.propertyLocation}</Typography>
                  </Box>
                </Stack>
                <Divider />
                <Stack direction="row" spacing={2} alignItems="center">
                  ...
                  <Box>
                    <Typography sx={{ fontSize: 12, color: '#6B7280', mb: 0.5 }}>Check-in</Typography>
                ...
                <Stack direction="row" spacing={2} alignItems="center">
                  ...
                  <Box>
                    <Typography sx={{ fontSize: 12, color: '#6B7280', mb: 0.5 }}>Check-out</Typography>
                    <Typography sx={{ fontWeight: 600, color: '#111827' }}>
                ...
                <Divider />
                <Box>
                  <Typography sx={{ fontSize: 12, color: '#6B7280', mb: 1 }}>Total Amount</Typography>
                  <Typography variant="h5" sx={{ fontWeight: 700, color: '#111827' }}>
                    {booking.amount}
                  </Typography>
