              ...
              <Box>
                ...
                <Paper elevation={0} sx={{ bgcolor: 'transparent' }}>
                  <Stack spacing={2.5}>
                    ...
                    <Button variant="contained" size="large" sx={{ width: { xs: '100%', md: formWidth }, height: 52, borderRadius: 999, textTransform: 'none', fontWeight: 700, fontSize: 16, bgcolor: '#FF8C75', boxShadow: 'none', '&:hover': { bgcolor: '#ff7a61', boxShadow: 'none' } }}>
                      Sign in
                    </Button>
                ...
                <Typography variant="body2" color="text.secondary" sx={{ textAlign: 'center', mt: 4 }}>
                  ...
                  <MUILink component={Link} to="/auth/signup" underline="none" sx={{ color: '#ff7358', fontWeight: 600 }}>
                    Sign up
                  </MUILink>
                </Typography>
              </Box>
