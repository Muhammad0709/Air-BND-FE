                ...
                <Table sx={{ minWidth: 800, width: '100%' }}>
                  <TableHead>
                    <TableRow sx={{ bgcolor: '#F9FAFB' }}>
                      <TableCell sx={{ fontWeight: 700, color: '#111827', whiteSpace: 'nowrap' }}>Booking ID</TableCell>
                      ...
                      <TableCell sx={{ fontWeight: 700, color: '#111827', whiteSpace: 'nowrap' }}>Date</TableCell>
                      ...
                      <TableCell sx={{ fontWeight: 700, color: '#111827', whiteSpace: 'nowrap' }}>Payout Date</TableCell>
                  ...
                  <TableBody>
                    {filteredEarnings.map((earning) => (
                      <TableRow key={earning.id} sx={{ '&:hover': { bgcolor: '#F9FAFB' } }}>
                        <TableCell sx={{ fontWeight: 600, color: '#111827' }}>{earning.bookingId}</TableCell>
                        <TableCell>{earning.guest}</TableCell>
                        <TableCell>{earning.property}</TableCell>
                        <TableCell sx={{ color: '#6B7280' }}>{earning.date}</TableCell>
                        <TableCell sx={{ fontWeight: 700, color: '#111827', whiteSpace: 'nowrap' }}>{earning.amount}</TableCell>
                        <TableCell>
                          <Chip
                        ...
                        <TableCell sx={{ color: '#6B7280' }}>{earning.payoutDate}</TableCell>
                        <TableCell>
                          <ActionsMenu
            ...
            <CardContent>
              ...
              <TableContainer sx={{ overflowX: 'auto', maxWidth: '100%', WebkitOverflowScrolling: 'touch' }}>
                <Table sx={{ minWidth: 700, width: '100%' }}>
                  <TableHead>
                    <TableRow sx={{ bgcolor: '#F9FAFB' }}>
                      <TableCell sx={{ fontWeight: 700, color: '#111827', whiteSpace: 'nowrap' }}>Payout ID</TableCell>
                      <TableCell sx={{ fontWeight: 700, color: '#111827', whiteSpace: 'nowrap' }}>Amount</TableCell>
                      <TableCell sx={{ fontWeight: 700, color: '#111827', whiteSpace: 'nowrap' }}>Date</TableCell>
                      <TableCell sx={{ fontWeight: 700, color: '#111827', whiteSpace: 'nowrap' }}>Method</TableCell>
                      <TableCell sx={{ fontWeight: 700, color: '#111827', whiteSpace: 'nowrap' }}>Account</TableCell>
                      <TableCell sx={{ fontWeight: 700, color: '#111827', whiteSpace: 'nowrap' }}>Status</TableCell>
                      <TableCell sx={{ fontWeight: 700, color: '#111827', whiteSpace: 'nowrap' }}>Actions</TableCell>
                    </TableRow>
                  </TableHead>
                  <TableBody>
                    {payouts.map((payout) => (
                      <TableRow key={payout.id} sx={{ '&:hover': { bgcolor: '#F9FAFB' } }}>
                        <TableCell sx={{ fontWeight: 600, color: '#111827' }}>{payout.payoutId}</TableCell>
                        <TableCell sx={{ fontWeight: 700, color: '#111827' }}>{payout.amount}</TableCell>
                        <TableCell sx={{ color: '#6B7280' }}>{payout.date}</TableCell>
                        <TableCell sx={{ color: '#6B7280' }}>{payout.method}</TableCell>
                        <TableCell sx={{ color: '#6B7280' }}>{payout.account}</TableCell>
                        <TableCell>
                          <Chip
                            label={payout.status}
                            size="small"
