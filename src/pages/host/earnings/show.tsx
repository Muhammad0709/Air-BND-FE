            ...
            <CardContent sx={{ p: { xs: 2, md: 4 } }}>
              ...
              <Stack spacing={3}>
                <Stack direction="row" spacing={2} alignItems="center">
                  ...
                  <Box>
                    <Typography sx={{ fontSize: 12, color: '#6B7280', mb: 0.5 }}>Guest</Typography>
                    <Typography sx={{ fontWeight: 600, color: '#111827' }}>{earning.guest}</Typography>
                  </Box>
                </Stack>
                ...
                <Stack direction="row" spacing={2} alignItems="center">
                  ...
                  <Box>
                    ...
                    <Typography sx={{ fontWeight: 600, color: '#111827' }}>{earning.property}</Typography>
                  </Box>
                </Stack>
                ...
                <Stack direction="row" spacing={2} alignItems="center">
                  ...
                  <Box>
                    <Typography sx={{ fontSize: 12, color: '#6B7280', mb: 0.5 }}>Booking Date</Typography>
            ...
            <CardContent sx={{ p: { xs: 2, md: 4 } }}>
              ...
              <Stack spacing={3}>
                <Stack direction="row" spacing={2} alignItems="center">
                  ...
                  <Box>
                    <Typography sx={{ fontSize: 12, color: '#6B7280', mb: 0.5 }}>Total Amount</Typography>
                ...
                <Stack direction="row" spacing={2} alignItems="center">
                  ...
                  <Box>
                    <Typography sx={{ fontSize: 12, color: '#6B7280', mb: 0.5 }}>Commission (10%)</Typography>
                    <Typography sx={{ fontWeight: 600, color: '#111827' }}>{earning.commission}</Typography>
                  </Box>
                </Stack>
                ...
                <Stack direction="row" spacing={2} alignItems="center">
                  ...
                  <Box>
                    <Typography sx={{ fontSize: 12, color: '#6B7280', mb: 0.5 }}>Net Amount</Typography>
                ...
                <Box>
                  <Typography sx={{ fontSize: 12, color: '#6B7280', mb: 1 }}>Payout Date</Typography>
                  <Typography sx={{ fontWeight: 600, color: '#111827' }}>
                    {earning.payoutDate !== '-' 
