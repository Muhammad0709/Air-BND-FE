            ...
            <CardContent sx={{ p: { xs: 2, md: 4 } }}>
              ...
              <Stack spacing={3}>
                ...
                <Stack direction="row" spacing={2} alignItems="center">
                  ...
                  >
                    <PaymentIcon sx={{ fontSize: 20, color: '#6B7280' }} />
                  </Box>
                  <Box>
                    <Typography sx={{ fontSize: 12, color: '#6B7280', mb: 0.5 }}>Payment Method</Typography>
                    <Typography sx={{ fontWeight: 600, color: '#111827' }}>{payout.method}</Typography>
                  </Box>
                </Stack>
                ...
                <Stack direction="row" spacing={2} alignItems="center">
                  ...
                  <Box>
                    <Typography sx={{ fontSize: 12, color: '#6B7280', mb: 0.5 }}>Account</Typography>
                    <Typography sx={{ fontWeight: 600, color: '#111827' }}>{payout.account}</Typography>
                  </Box>
                </Stack>
              </Stack>
            </CardContent>
            ...
            <CardContent sx={{ p: { xs: 2, md: 4 } }}>
              ...
              <Stack spacing={3}>
                <Stack direction="row" spacing={2} alignItems="center">
                  ...
                  <Box>
                    <Typography sx={{ fontSize: 12, color: '#6B7280', mb: 0.5 }}>Request Date</Typography>
                ...
                <Stack direction="row" spacing={2} alignItems="center">
                  ...
                  <Box>
                    <Typography sx={{ fontSize: 12, color: '#6B7280', mb: 0.5 }}>Processed Date</Typography>
                    <Typography sx={{ fontWeight: 600, color: '#111827' }}>
                ...
                <Box>
                  <Typography sx={{ fontSize: 12, color: '#6B7280', mb: 1 }}>Transaction ID</Typography>
