import { Card, CardContent, Stack, Table, TableBody, TableCell, TableContainer, TableHead, TableRow, Typography, Chip, Box } from '@mui/material'
...
export default function HostDashboard() {
  const stats = [
    { title: 'Total Properties', value: '12', icon: HotelIcon, color: '#FF8C75', change: '+2 this month' },
