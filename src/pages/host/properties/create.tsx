                  ...
                  {amenitiesList.map((amenity) => (
                    <Button
                      ...
                      sx={{
                        ...
                        borderRadius: 2,
                        borderColor: '#D1D5DB',
                        color: formData.amenities.includes(amenity) ? '#FFFFFF' : '#6B7280',
                        bgcolor: formData.amenities.includes(amenity) ? '#FF8C75' : 'transparent',
                        '&:hover': {
                          bgcolor: formData.amenities.includes(amenity) ? '#ff7a61' : '#F9FAFB',
                          borderColor: '#9CA3AF'
                        }
                      }}
                    >
